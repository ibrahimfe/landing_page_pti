...
const Pricing = () => {
  ...
  return <section className='section'>
    <div className='container mx-auto'>
      <h2 className='h2 mb-10 lg:m-20 text-center'
        data-aos='fade-up'
        data-aos-delay='200'
      >{title}</h2>
      <div className='flex flex-col lg:flex-row lg:gap-x-[30px] 
            gap-y-[30px] lg:gap-y-0 justify-center items-center'>
        {cards.map((card, cardIndex) => {
          ...
          return <div data-aos='fade-up'
            ...
            <div
              ...
              className={`${cardIndex === index ? 'bg-white shadow-2xl' : 'border border-grey'}
                            w-[350px] h-[500] rounded-[12px] p-[40px] 
                            cursor-pointer transition-all bg-pink-50`}>
              {/** */}
              <div className='mb-8'>
                <img src={icon} alt='' />
              </div>
